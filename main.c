...
void
log_msg(int level, char * message)
{
    log(level, "%s", message);
}
...
static void
elevator_move_direction_check(int elevator, int direction)
{
...
void
elevator_move_direction(int elevator, int direction)
{
...
static void
elevator_open_door_check(int elevator)
{
    pthread_mutex_lock(&state_lock);
...
void
elevator_open_door(int elevator)
{
...
void
elevator_close_door(int elevator)
{
    pthread_mutex_lock(&state_lock);
    elevator_check(elevator);
...
/* This is an internal struct used by the enforcement system
     - there is no access to this from hw5.c. */
...
static void
passenger_enter_check(int passenger, int elevator)
{
    pthread_mutex_lock(&state_lock);
...
void
passenger_enter(int passenger, int elevator)
{
...
static void
passenger_exit_check(int passenger, int elevator)
{
    pthread_mutex_lock(&state_lock);
...
void
passenger_exit(int passenger, int elevator)
{
